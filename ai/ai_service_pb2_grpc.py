...
class FileProcessingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessFile = channel.unary_unary(
                '/ai.FileProcessingService/ProcessFile',
                request_serializer=ai__service__pb2.FileRequest.SerializeToString,
                response_deserializer=ai__service__pb2.FileResponse.FromString,
                _registered_method=True)
...
def add_FileProcessingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessFile': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ai__service__pb2.FileRequest.FromString,
                    response_serializer=ai__service__pb2.FileResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'ai.FileProcessingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ai.FileProcessingService', rpc_method_handlers)
...
class FileProcessingService(object):
    ...
    def ProcessFile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ai.FileProcessingService/ProcessFile',
            ai__service__pb2.FileRequest.SerializeToString,
            ai__service__pb2.FileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
