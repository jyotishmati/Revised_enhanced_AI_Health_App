    ...
    <View style={styles.functionalChartRow}>
      ...
      <View style={styles.functionalBarContainer}>
        ...
        <View style={styles.functionalBarSegmentsContainer}>
          <View
            style={[
              styles.functionalBarSegmentBase,
              { backgroundColor: FUNCTIONAL_CHART_COLORS.current },
          ...
          {data.warningValue > 0 ? (
            <View
              style={[
                styles.functionalBarSegmentBase,
                { backgroundColor: FUNCTIONAL_CHART_COLORS.warning },
      ...
      >
        ...
        {selectedOrgan === "heart" ? (
          <View style={styles.contentCard}>
            <Text style={styles.functionalChartTitle}>
              Heart Functional Parts
            </Text>
            ...
            <View style={styles.functionalLegendContainer}>
              <View style={styles.functionalLegendItem}>
                <View
                  style={[
                    styles.functionalLegendColorBox,
                    { backgroundColor: FUNCTIONAL_CHART_COLORS.current },
                  ]}
                />
            ...
            <View style={styles.functionalXAxisContainer}>
              {[20, 40, 60, 80].map((val) => (
                <View
                  key={val}
                  style={[styles.functionalGridLine, { left: `${val}%` }]}
                />
              ))}
          ...
          <View style={styles.medsContent}>
            <View style={styles.timestampContainer}>
              <Text style={styles.timestampText}>
                September 23, 2024 20:30PM
              </Text>
            </View>
            {medicationsData.slice(0, 3).map((med, index) => (
              <View
                key={med.id}
                style={[styles.medItem, index < 2 && styles.medItemBorder]}
              >
          ...
          <View style={styles.medsHeaderFooter}>
            ...
            <View style={styles.medsFooterStatus}>
              <Text style={styles.medsFooterText}>
                {medicationsData.filter((m) => m.taken === true).length}/
          ...
          <View style={styles.activityStatusLegendRow}>
            ...
            <View style={styles.activityLegendContainer}>
              <View style={styles.activityLegendItem}>
                <View
                  style={[
                    styles.activityLegendColorBox,
                    { backgroundColor: ACTIVITY_CHART_COLORS.heartRate },
                  ]}
                />
              ...
              <View style={styles.activityLegendItem}>
                <View
                  style={[
                    styles.activityLegendColorBox,
                    { backgroundColor: ACTIVITY_CHART_COLORS.glucose },
                  ]}
                />
              ...
              <View style={styles.activityLegendItem}>
                <View
                  style={[
                    styles.activityLegendColorBox,
                    { backgroundColor: ACTIVITY_CHART_COLORS.bloodCount },
                  ]}
                />
...
const styles = StyleSheet.create({
  ...
  activityStatusLegendRow: {
    // NEW: Container for Status + Legend
    flexDirection: "row",
    justifyContent: "space-between",
  ...
  activityChartArea: {
    // UPDATED: Chart area itself
    height: 150, // Height for bars + labels below
    position: "relative",
    width: "100%", // Ensure it takes full width
  },
  activityChartBackgroundLine: {
    // UPDATED: Renamed and simplified
    position: "absolute",
  ...
  activityChartBarsOverlay: {
    // Container for the bar groups + labels
    position: "absolute",
    top: 0,
