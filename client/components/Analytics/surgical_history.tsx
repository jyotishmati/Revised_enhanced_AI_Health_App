    ...
    <View style={styles.cardContainer}>
      ...
      <View style={styles.cardHeader}>
        ...
        <TouchableOpacity onPress={onPressIcon} style={styles.iconButton}>
          {/* Using 'eye-outline' which is common in Ionicons */}
        ...
        <View style={[styles.cardContainer, styles.medBandContainer]}>
            ...
            <View style={styles.switchContainer}>
                <Switch
                    ...
                    thumbColor={isConnected ? "#007AFF" : "#f4f3f4"} // Example colors
                    ios_backgroundColor="#3e3e3e"
                    onValueChange={() => setIsConnected(previousState => !previousState)}
                    value={isConnected}
                    style={styles.switch}
                 />
