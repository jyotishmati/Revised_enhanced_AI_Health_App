...
describe("Master Health API End-to-End Tests", () => {
    it("should create a new master health record", () => __awaiter(void 0, void 0, void 0, function* () {
        const healthData = {
            tests: [
                {
    ...
    it("should update an existing master health record", () => __awaiter(void 0, void 0, void 0, function* () {
        const updateData = {
            tests: [
                {
                    categories: "Blood Test",
    ...
    it("should retrieve all master health records for a user", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(app_1.default)
    ...
    it("should return an error when no test data is provided", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(app_1.default)
            .post("/api/master-health/update-master-health")
            .set("Authorization", `Bearer ${authToken}`)
            .send({});
    ...
    it("should return an error when user is not authenticated", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(app_1.default).get("/api/master-health/get-master-health");
        expect(res.status).toBe(401);
        expect(res.body.message).toBe("Unauthorized");
    }));
    it("should return an empty response when no health records are found", () => __awaiter(void 0, void 0, void 0, function* () {
        yield masterHealthModel_1.default.deleteMany(); // Clear all records
        const res = yield (0, supertest_1.default)(app_1.default)
            .get("/api/master-health/get-master-health")
            .set("Authorization", `Bearer ${authToken}`);
        expect(res.status).toBe(200);
...
//# sourceMappingURL=masterHealthModel.test.js.map